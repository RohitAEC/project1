...
String QueryString = "SELECT district from tbl_region where state='"+s+"' group by district";
ResultSet rs = statement.executeQuery(QueryString);

           
String output = "<option value=''>Select</option>";
while(rs.next()){  
    output+="<option value='"+rs.getString("district")+"'>"+rs.getString("district")+"</option>";
